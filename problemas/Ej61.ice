    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "EJERCICIO 6.1.\tUna sala tiene 5 puertas: A, B, C, D y E. La puerta E está automatizada,de modo que permanece abierta únicamente si hay un número impar de puertas abiertas.\r\nDiseña un circuito lógico, con puertas de cualquier tipo, que permita el control de E.",
            "readonly": true
          },
          "position": {
            "x": -176,
