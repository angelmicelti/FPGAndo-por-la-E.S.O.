{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "dd7fab51-a57e-4e99-be1c-4580fa0692ac",
          "type": "basic.output",
          "data": {
            "name": "Serial",
            "pins": [
        ...
        {
          "id": "4537c2bf-0e75-4613-8bed-2ba06738785f",
        ...
        {
          "id": "8b59b11b-178f-404c-ae55-63e5641b9904",
        ...
        {
          "id": "df0ed145-c403-4cea-9f04-3485c6fe2c7f",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "5800d982-2fbd-432e-8284-f8f03d36e191",
          "type": "basic.outputLabel",
          "data": {
            "blockColor": "fuchsia",
            "name": "Limpia",
        ...
        {
          "id": "c4a995af-90c1-4a28-9154-c945c99c3ca7",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "\"M\"",
        ...
        {
          "id": "c42e5bf5-8fcc-4b55-a4ab-7de27875f8bd",
          "type": "basic.info",
          "data": {
            "info": "### Virtual LED",
            "readonly": true
        ...
        {
          "id": "9ce92c7a-834a-4c9c-822d-5672496ef527",
          "type": "basic.info",
          "data": {
            "info": "### Real LED",
            "readonly": true
        ...
        {
          "id": "9166ab70-01eb-46c3-9cfe-75d57b753950",
        ...
        {
          "id": "70e531b3-b3a3-4dff-9d75-e1ec8f387e94",
          "type": "0f77453e654c0edf6e3580a3cb543a74bcad1052",
          "position": {
            "x": 728,
            "y": 232
          },
      ...
      "wires": [
        {
          "source": {
            "block": "5800d982-2fbd-432e-8284-f8f03d36e191",
            "port": "outlabel"
          },
          "target": {
            "block": "df0ed145-c403-4cea-9f04-3485c6fe2c7f",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "9166ab70-01eb-46c3-9cfe-75d57b753950",
            "port": "a0a2b78e-31fb-42b4-84d5-c3484030cf42"
          },
          "target": {
            "block": "dd7fab51-a57e-4e99-be1c-4580fa0692ac",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "c4a995af-90c1-4a28-9154-c945c99c3ca7",
            "port": "constant-out"
          },
          "target": {
            "block": "9166ab70-01eb-46c3-9cfe-75d57b753950",
        ...
        {
          "source": {
            "block": "4537c2bf-0e75-4613-8bed-2ba06738785f",
            "port": "outlabel"
          },
          "target": {
            "block": "9166ab70-01eb-46c3-9cfe-75d57b753950",
        ...
        },
        {
          ...
          "target": {
            "block": "70e531b3-b3a3-4dff-9d75-e1ec8f387e94",
        ...
        },
        {
          ...
          "target": {
            "block": "8b59b11b-178f-404c-ae55-63e5641b9904",
            "port": "inlabel"
          }
        }
      ]
  ...
  "dependencies": {
    ...
    "0f77453e654c0edf6e3580a3cb543a74bcad1052": {
      "package": {
        "name": "Bloque solución del Problema 4 del Boletín 11",
        "version": "",
        "description": "",
        "author": "Ángel Millán León",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20viewBox=%220%200%2063.894856%2030.472465%22%20height=%22115.172%22%20width=%22241.492%22%3E%3Ctext%20transform=%22translate(-69.725%20-126.859)%22%20stroke-width=%22.265%22%20word-spacing=%220%22%20letter-spacing=%220%22%20font-family=%22sans-serif%22%20font-size=%2210.583%22%20font-weight=%22400%22%20y=%22139.408%22%20x=%22101.223%22%20style=%22line-height:1.25%22%3E%3Ctspan%20text-anchor=%22middle%22%20style=%22text-align:center%22%20y=%22139.408%22%20x=%22101.223%22%3EPROBLEMA%3C/tspan%3E%3Ctspan%20text-anchor=%22middle%22%20style=%22text-align:center%22%20y=%22152.637%22%20x=%22101.223%22%3E11.4%3C/tspan%3E%3C/text%3E%3Cpath%20d=%22M.388.388h63.118v29.696H.388z%22%20stroke-width=%22.777%22%20stroke=%22#000%22%20fill=%22none%22/%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            ...
            },
            {
              ...
              "type": "basic.info",
              "data": {
                "info": "<h3 style=\"color:green\">**PROBLEMA 11.4.**</h3> Un limpiaparabrisas automático de un automóvil posee un LED emisor de luz (invisible para nosotros)\r\ny otro diodo sensible a la luz (detector).\r\nCuando la luz emitida por el primero se refleja en una gota de lluvia y llega al detector, éste se activa.\r\nPues bien, en un automóvil se han colocado cuatro de estos detectores, y el limpiaparabrisas se pone en marcha únicamente\r\ncuando dos o más de los detectores se activan.\r\n",
                "readonly": true
              },
              "position": {
                "x": -160,
            ...
            {
              "id": "6f7be8a5-efa5-43c0-8e41-c7b5318d8332",
              "type": "11a6f454705778e2f00adba4e5b28dcd9411bc8f",
              "position": {
                "x": 136,
                "y": 192
            ...
            {
              "id": "a4747729-67a2-46dc-a303-94d4bfcecea6",
              "type": "11a6f454705778e2f00adba4e5b28dcd9411bc8f",
              "position": {
                "x": 136,
                "y": 280
            ...
            {
              "id": "8cb890c1-22d7-41ec-9a3b-8ce3c9faf550",
              "type": "11a6f454705778e2f00adba4e5b28dcd9411bc8f",
              "position": {
                "x": 136,
                "y": 368
            ...
            {
              "id": "f640f0f5-fcaa-4206-bf0d-415e20c800df",
            ...
            {
              "id": "863edfc9-59ba-4172-b773-642bc150dd85",
              "type": "7e25215728ce70288b7c56809015298637994bb1",
              "position": {
                "x": 304,
                "y": 264
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "6f7be8a5-efa5-43c0-8e41-c7b5318d8332",
                "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
              },
              "vertices": [
                {
            ...
            },
            {
              ...
              "target": {
                "block": "a4747729-67a2-46dc-a303-94d4bfcecea6",
                "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
              },
              "vertices": [
                {
            ...
            },
            {
              ...
              "target": {
                "block": "8cb890c1-22d7-41ec-9a3b-8ce3c9faf550",
                "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
              },
              "vertices": [
                {
            ...
            },
            {
              ...
              "target": {
                "block": "f640f0f5-fcaa-4206-bf0d-415e20c800df",
                "port": "97b51945-d716-4b6c-9db9-970d08541249"
              }
            },
            {
            ...
            },
            {
              ...
              "target": {
                "block": "863edfc9-59ba-4172-b773-642bc150dd85",
                "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
              }
            },
            {
